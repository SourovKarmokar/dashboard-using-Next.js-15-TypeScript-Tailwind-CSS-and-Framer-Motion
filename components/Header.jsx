  ...
  return (
   <header className='bg-[#1e1e1e] shadow-lg border-b border-[#1f1f1f] mx-4 sm:mx-6 lg:mx-8 mt-4 mb-2 rounded-lg'>
      ...
      <div className='flex items-center space-x-3 sm:space-x-6'>
        <Image src={uk} alt='img' width={25} height={18} className="rounded-full shadow-md cursor-pointer" />
        ...
        <div className='flex items-center space-x-2 sm:space-x-3'>
          <Image src={admin} width={35} height={35} className='rounded-full border border-gray-600' />

          <span className=' hidden sm:block to-gray-100 font-medium '>Sourov</span>
        </div>
